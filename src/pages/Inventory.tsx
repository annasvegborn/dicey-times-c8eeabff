...
const Inventory = () => {
  ...
  return (
    <div className="min-h-screen bg-[#ecd4ab]">
      ...
      <div className="p-4">
        {/* Inventory Stats */}
        <div className="bg-[#ecd4ab] rounded-3xl p-4 border-4 border-[#422e18] mb-4 shadow-2xl">
        ...
        {inventoryItems.length > 0 ? (
          <div className="space-y-4">
            {inventoryItems.map((item) => (
              <div key={item.id} className="bg-[#ecd4ab] rounded-3xl p-6 border-4 border-[#422e18] shadow-2xl">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className={`font-serif border-2 capitalize ${getRarityColor(item.rarity)}`}>
                        {item.rarity}
                      </Badge>
                    </div>
                  </div>
                  <div className="flex flex-col gap-2">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="text-[#422e18] border-2 border-[#997752] hover:bg-[#997752] hover:text-[#ecd4ab] rounded-xl font-serif"
                    >
                      Drop
                    </Button>
                  </div>
          ...
          <div className="bg-[#ecd4ab] rounded-3xl p-8 border-4 border-[#422e18] shadow-2xl text-center">
